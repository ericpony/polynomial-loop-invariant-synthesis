module.exports = {
        /**
         * Program: x=1; while(x!=0){ (x=0)[p](n=n+y); }
         * Domain:  n>=0, y>=0, x>=0
         * Param:   p=0.25
         * Rule: pre-condition <= I(x,y,n)
         *       x!=0 impl 4*I(x,y,n) <= 3*I(0,y,n)+I(x,y,n+y)
...
//                   if(n<0 || y<0 || (x!=1 && x!=0)) return null;
                   ...
                   if(x!=0) constraints.push('4*' + I(x,y,n) + '<=' + I(0,y,n) + '+3*' + I(x,y,n+y));
                   if(x==0) {
        ...
        rule:  function(pre, post) {
                   return AND(
                       pre + '<=I[x,y,n]',
                       IMP('x<>0', '4*I[x,y,n]<=I[0,y,n]+3*I[x,y,n+y]'),
