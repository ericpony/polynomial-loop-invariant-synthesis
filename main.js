...
var main = (function() {
  ...
  function test_coeff(coeff, coeff_list, constraints, invariant_regex, template, sample_space) {
    ...
    */
    ...
    var invariant = (function() {
      ...
      while(times_to_try-->0) {
        ...
        if(invariant[0]) {
          ...
          if(invariant[0]) return coeff;      // invariant found; return coeff
    ...
    if(invariant) {
      ...
      invariant = (function(coeff) {
        ...
        var _z3_prog = mk_symbolic(bind_coeff(coeff, template.replace(/\^/g,'**').replace(/\$(\d+)/g,
...
var rule, ruleRL, ruleJS, precond, postcond, num_vars, num_samples, testcase = {};
